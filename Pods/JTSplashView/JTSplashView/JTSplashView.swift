...
public class JTSplashView: UIView {
    
    // MARK: Properties
    public static let sharedInstance = JTSplashView()
    ...
    */
    public class func splashViewWithBackgroundColor(backgroundColor: UIColor?, circleColor: UIColor?, circleSize: CGSize?) {
    ...
    */
    public class func finishWithCompletion(completion: (() -> Void)?) {
